          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-white/[0.05] bg-white/[0.01]">
                ...
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white/20">Loyalty Tier</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white/20">Orders</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-white/20">Total Spend</th>
                    ...
                    <td className="px-8 py-5">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-[9px] text-white/20 mt-1 uppercase font-bold truncate max-w-[150px]">{customer.firstName} {customer.lastName}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-8 py-5">
                       <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-[0.15em] border ${getTierColor(customer.loyaltyTier)}`}>
                          <Star className="w-2.5 h-2.5 fill-current" />
                          {customer.loyaltyTier}
                       </div>
                    </td>
                    <td className="px-8 py-5">
                       <span className="text-[10px] font-black text-white/40">{customer._count.orders} ORDERS</span>
                    </td>
                    <td className="px-8 py-5 font-mono text-xs text-white">
                       {formatNaira(Number(customer.totalSpend))}
                    </td>
