        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6 bg-black/80 backdrop-blur-sm">
          ...
          >
            ...
            <div className="flex flex-col items-center text-center">
              <div className={`w-16 h-16 rounded-full bg-white/[0.03] border border-white/5 flex items-center justify-center mb-8 ${colorClass}`}>
                <Icon className="w-8 h-8" />
              </div>

              <h2 className="text-xl font-black uppercase tracking-[0.2em] text-white mb-4">
                {title}
              </h2>
              
              <p className="text-[13px] text-white/40 font-medium leading-relaxed uppercase tracking-widest">
                {message}
              </p>

              <button
                onClick={onClose}
                className="mt-10 w-full py-5 rounded-2xl bg-white text-black text-[11px] font-black uppercase tracking-[0.3em] hover:scale-[1.02] active:scale-95 transition-all"
              >
                Continue
              </button>
            </div>
